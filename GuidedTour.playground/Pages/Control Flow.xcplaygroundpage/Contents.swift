...
var optionalStringK: String? = "Hello"
print(optionalStringK == nil)
var optionalNameK: String? = "John Appleseed"
optionalNameK = nil
var greetingK = "Hello!"
if let nameK = optionalNameK {
    greetingK = "Hello, \(nameK)"
} else {
    greetingK = "Hello, Stranger"
}
//: - Experiment:
